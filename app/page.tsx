...
import { Globe, Package, Truck, Users, Eye, Star, Check, ShoppingCart, Box } from "lucide-react";
...
const translations = {
  en: {
    ...
    description:
      "We specialize in bulk supply of premium Thai products to Bangladesh. We handle all shipping logistics and provide comprehensive support to help entrepreneurs establish successful businesses.",
  ...
  th: {
    ...
    description:
      "เราเชี่ยวชาญในการจัดหาผลิตภัณฑ์ไทยคุณภาพสูงให้กับบังกลาเทศ เราจัดการโลจิสติกส์การจัดส่งทั้งหมด และให้การสนับสนุนอย่างครอบคลุมเพื่อช่วยผู้ประกอบการสร้างธุรกิจที่ประสบความสำเร็จ",
    ...
    bulkPricing: "มีราคาส่ง",
    minimumOrder: "ขั้นต่ำการสั่งซื้อ",
  },
  bn: {
    companyName: "লোটাস অ্যান্ড লিলি ট্রেডিং",
    tagline: "বাংলাদেশে থাই পণ্যের জন্য আপনার বিশ্বস্ত অংশীদার",
    description:
      "আমরা বাংলাদেশে প্রিমিয়াম থাই পণ্যের বাল্ক সরবরাহে বিশেষজ্ঞ। আমরা সমস্ত শিপিং লজিস্টিক্স পরিচালনা করি এবং উদ্যোক্তাদের সফল ব্যবসা প্রতিষ্ঠায় সহায়তা করার জন্য ব্যাপক সহায়তা প্রদান করি।",
    catalogue: "পণ্যের ক্যাটালগ",
    price: "মূল্য",
    shipping: "শিপিং",
    total: "মোট",
    per: "প্রতি",
    perCarton: "প্রতি কার্টন",
    perPiece: "প্রতি পিস",
    pieces: "পিস",
    carton: "কার্টন",
    category: "বিভাগ",
    ...
    contactDesc:
      "আপনার ব্যবসা শুরু করার জন্য প্রস্তুত? আজই আমাদের সাথে যোগাযোগ করুন!",
    bulkPricing: "বাল্ক মূল্য উপলব্ধ",
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {products.map((product) => (
              <Card
                key={product.id}
                className="hover:shadow-xl transition-shadow duration-300 bg-white border-2 hover:border-yellow-400"
              >
                <CardContent className="p-6">
                        ...
                        <div className="aspect-square bg-gray-100 rounded-lg overflow-hidden cursor-pointer group relative">
                          <img
                            ...
                            onError={(e) => {
                              ...
                              target.src =
                                "https://images.pexels.com/photos/4198375/pexels-photo-4198375.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&dpr=1";
                            }}
                          />
                        ...
                        <div className="grid grid-cols-4 gap-2">
                          {product.images.slice(0, 8).map((img, index) => (
                            <button
                              key={index}
                              onClick={() =>
                                handleImageSelect(product.id, index)
                              }
                      ...
                      {product.variants && product.variants.length > 0 && (
                        ...
                        >
                          {expandedProduct === product.id
                            ? "Hide Details"
                            : `View ${product.variants.length} ${t.variants}`}
                        </Button>
                      )}
                    </div>
                  </div>
                    ...
                    <div className="mt-6 pt-6 border-t">
                        ...
                        {product.variants.map((variant, index) => (
                          ...
                          >
                            ...
                            <div className="flex-1">
                              ...
                              {/* New Pricing Structure for Kodomo Products */}
                              {variant.piecesPerCarton && variant.pricePerCarton && variant.pricePerPiece ? (
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs">
                                  <div className="bg-white p-2 rounded border">
                                    <div className="text-gray-500">{t.minimumOrder}</div>
                                    <div className="font-semibold text-green-700">
                                      {variant.piecesPerCarton} {t.pieces}
                                    </div>
                                  </div>
                                  <div className="bg-white p-2 rounded border">
                                    <div className="text-gray-500">{t.perCarton}</div>
                                    <div className="font-semibold text-yellow-600">
                                      ৳{formatPrice(variant.pricePerCarton)}
                                    </div>
                                  </div>
                                  <div className="bg-white p-2 rounded border">
                                    <div className="text-gray-500">{t.perPiece}</div>
                                    <div className="font-semibold text-blue-600">
                                      ৳{formatPrice(variant.pricePerPiece)}
                                    </div>
                                  </div>
                                </div>
                              ) : (
                                // Fallback for products without the new structure
                      ...
                      <div className="mt-4 p-3 bg-green-50 rounded-lg border-l-4 border-green-400">
                        <p className="text-sm text-green-800">
                          <strong>Note:</strong> Every Item will be monitored in details while purchase
                        </p>
                      </div>
                    </div>
                  )}
...
<Button
  ...
  onClick={() => window.open('https://wa.me/66928148796', '_blank')}
>
  Get Started Today
</Button>
        </div>
